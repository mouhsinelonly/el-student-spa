  ...
  return <div className='shadow-1 p-y-2 MarketHeader'>
    <div className='container'>
      <div className='col-xs-10 col-xs-pull-1'>
        <div className='row'>
          <div className='col-xs-12 col-md-4 p-l-0'>
            <h4>
              <Link to='/eshop/dashboard' className='MarketHeader__home'>
          ...
          <div className='col-xs-12 col-md-2 m-t-1'>
           ...
           <div className='col-xs-12 col-md-1 p-l-0 m-t-2'>
