...
import { Soon, ChooseDeliveryDay } from '../../components'
import { toggleCartVisibility, getOrders } from 'routes/Student/modules/market'
  ...
  <div className='shadow-1 p-y-2 MarketHeader' style={{ position: 'sticky', top: 0, zIndex: 99 }}>
    <div className='container'>
      <div className='row'>
        ...
        <Link to='/student/market' className='MarketHeader is-orders'>
