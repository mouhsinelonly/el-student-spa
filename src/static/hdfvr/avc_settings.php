...
//The recorderId query vairable contains the value of the recorderId variable sent to videorecorder.swf via flash vars.
...
//values: 1 for enabled, 0 for disasbled 
//default:0 (disabled)
$config["hideDeviceSettingsButtons"] = 0;
